...
این اسکریپت Python 3.13 را نصب می‌کند، فایل‌ها را به `/opt/ghostnode` کپی می‌کند، داده‌های GeoIP/GeoSite را دانلود می‌کند و یک سرویس systemd راه‌اندازی می‌کند.
...
| `fp` | اثر انگشت SHA-256 کلید عمومی سرور (base64url، برای محافظت در برابر MITM) |
| `#Name` | برچسب قابل خواندن برای انسان برای کلاینت |
